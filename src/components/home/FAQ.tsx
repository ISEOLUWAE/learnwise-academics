...
const faqs = [
  ...
  },
  {
    ...
    answer: "Currently, Lumora is a web-based platform optimized for all devices. Our responsive design ensures you have a great experience on mobile, tablet, and desktop."
  },
  {
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Find answers to common questions about Lumora and how to make the most of our platform
          </p>
        </motion.div>
